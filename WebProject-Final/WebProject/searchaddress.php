    ...
    <main>
      <section class="banner">
        ...
        <div class="table-container">
                    ...
                    <?php
            // Retrieve the selected address from the form
            ...
            // Prepare the SQL query to search for students with the selected address
            $sql = "SELECT * FROM students WHERE address1 LIKE '%$address%' OR address2 LIKE '%$address%'";
